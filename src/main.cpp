...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		drawCircle(VAO1, shaderProgram, ldUniform, lightur, rot_uniform, light_uniform, rotMatrix, lightMatrix, 1.0f, proj, view, glm::mat4(1.0f), glm::vec3(1.0f), glm::vec3(0.0f), earthPallete, 1.0, gridSize, 6, seed);

		drawCircle(VAO1, shaderProgram, ldUniform, lightur, rot_uniform, light_uniform, rotMatrix2, lightMatrix, 0.8f, proj, view, glm::mat4(1.0f), glm::vec3(1.2f), glm::vec3(0.0f), cloudPallete, (float)glfwGetTime() * 0.3, 80, 4, cloudSeed);
...
void drawCircle(VAO& vao, Shader& shaderProgram, GLuint ldUniform, glm::vec3 ldr, GLuint rot, GLuint lrot, glm::mat3 rotMtx, glm::mat3 lightRot, glm::mat4 proj, glm::mat4 view, glm::mat4 model, glm::vec3 scale, glm::vec3 transform, float alpha, Pallete& col, float z, int gridSize, int octCount, int seed) {
...
std::pair<Planet, Planet> randomizePlanet() {
